...
<head>
  ...
  <title>UTS | Kurniawan Wijaya</title>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url();?>assets/img/aku.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Kurniawan Wijaya</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url();?>assets/img/aku.jpg" class="img-circle" alt="User Image">

                <p>
                  Kurniawan Wijaya - Web Developer
                  <small>Mangkung 2018</small>
                </p>
              </li>
              <!-- Menu Footer-->
