...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Inventaris</b>Hafizin</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url();?>/img/th5LBGX5LQ.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Hafizin</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url();?>/img/enjoy.jpg" class="img-circle" alt="User Image">

                <p>
                  Hafizin - Web Developer
    ...
    <section class="sidebar">
      ...
      <form action="#" method="get" class="sidebar-form">
        <div class="input-group">
          <input type="text" name="q" class="form-control" placeholder="Boyakn......">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018-<?php echo DATE('Y');?> <a href="#">EnjoyCoding</a>.</strong>@Define Your Program
  </footer>
