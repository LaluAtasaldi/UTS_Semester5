        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url();?>/img/D.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Lalu_Deden.JP</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url();?>/img/1IMG.jpg" class="img-circle" alt="User Image">

                <p>
                  Lalu_Deden.JP - Web Developer
