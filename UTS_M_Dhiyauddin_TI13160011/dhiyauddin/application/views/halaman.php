...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Inventaris</b>LDJP</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url();?>/img/IMG_7040.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">M.Dhiyauddin</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url();?>/img/IMG_7040.jpg" class="img-circle" alt="User Image">

                <p>
                  M.Dhiyauddin - Web Developer
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?php echo base_url();?>/img/IMG_7012.jpg" class="img-circle" alt="User Image">
        </div>
